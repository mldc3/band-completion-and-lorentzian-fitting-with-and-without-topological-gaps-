...
- Move hard-coded case parameters into YAML/JSON configuration files.
- Refactor scripts into reusable modules with clearer API boundaries.
- Add uncertainty quantification for fitted peaks and reconstructed bands.
- Standardize case execution and output export for reproducible comparisons.
- Add automated regression checks for representative datasets.
